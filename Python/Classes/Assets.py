...
class Asset:
    ...
    def get_item_size(self, size_type: DisplaySize = DisplaySize.Megabytes) -> str:
        ...
        """
        # Type checking
        if not isinstance(size_type, Assets.DisplaySize):
        ...
        SizeExtension = "KB" if size_type == Assets.DisplaySize.Kilobytes \
            else "MB" if size_type == Assets.DisplaySize.Megabytes \
            else "GB"
